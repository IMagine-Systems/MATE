...
import SignUpScreen from "./Screens/Login/SignUpScreen"; // 회원가입
...
import PassengerBordingList from "./Screens/List/PassengerBordingList";
  ...
  return (
    <NavigationContainer>
      ...
      >
        ...
        <Stack.Screen
          name="PassengerBordingList"
          component={PassengerBordingList}
        />
