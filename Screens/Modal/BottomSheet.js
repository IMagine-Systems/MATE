...
const BottomSheet = (props) => {
  ...
  const [startInputSelect, setStartInputSelect] = useState([
    false,
    false,
    false,
    false,
  ]); // (인동, 옥계, 본관, 항공관)
  const [endInputSelect, setEndInputSelect] = useState([
    false,
    false,
    false,
    false,
  ]); // (인동, 옥계, 본관, 항공관)
  const [rescruitmentButton, setRescruitmentButton] = useState([
    false,
    false,
    false,
    false,
                ...
                >
                  <View>
                    ...
                    >
                      ...
                      <TouchableOpacity
                        ...
                        style={StartInputButtonOneColor()}
                      >
                        <Text
                          style={
                            startInputSelect[0]
                      ...
                      <TouchableOpacity
                        ...
                        style={StartInputButtonTwoColor()}
                      >
                        <Text
                          style={
                            startInputSelect[1]
                      ...
                      <TouchableOpacity
                        ...
                        style={StartInputButtonThreeColor()}
                      >
                        <Text
                          style={
                            startInputSelect[2]
                      ...
                      <TouchableOpacity
                        ...
                        style={StartInputButtonFourColor()}
                      >
                        <Text
                          style={
                            startInputSelect[3]
                  ...
                  >
                    ...
                    <TouchableOpacity
                      ...
                      style={EndInputButtonThreeColor()}
                    >
                      <Text
                        style={
                          endInputSelect[2]
                ...
                <View style={{ flex: 1, justifyContent: "space-evenly" }}>
                  ...
                  >
                    ...
                    <TouchableOpacity
                      ...
                      style={RecruitmentButtonOneColor()}
                    >
                      <Text
                        style={
                          rescruitmentButton[0]
                            ? { color: "white" }
                            : { color: "black" }
                        }
                      >
                    ...
                    <TouchableOpacity
                      ...
                      style={RecruitmentButtonTwoColor()}
                    >
                      <Text
                        style={
                          rescruitmentButton[1]
                            ? { color: "white" }
                            : { color: "black" }
                        }
                      >
                    ...
                    <TouchableOpacity
                      ...
                      style={RecruitmentButtonThreeColor()}
                    >
                      <Text
                        style={
                          rescruitmentButton[2]
                            ? { color: "white" }
                            : { color: "black" }
                        }
                      >
                    ...
                    <TouchableOpacity
                      ...
                      style={RecruitmentButtonFourColor()}
                    >
                      <Text
                        style={
                          rescruitmentButton[3]
                            ? { color: "white" }
                            : { color: "black" }
                        }
                      >
                  ...
                  >
                    ...
                    <Input
                      ...
                      onChangeText={(text) =>
                        setArrivalTime(
                          (CarpoolTicket.CarpoolTicket[0].arrival_time = text)
                        )
                      }
                    />
                  </View>
                  ...
                  >
                    ...
                    <Input
                      containerStyle={{ width: "65%" }}
                      onChangeText={(text) =>
                        (CarpoolTicket.CarpoolTicket[0].open_chat = text)
                      }
                    />
                  </View>
                  ...
                  >
                    ...
                    <Input
                      containerStyle={{ width: "65%" }}
                      onChangeText={(text) =>
                        (CarpoolTicket.CarpoolTicket[0].open_chat_password =
                          text)
                      }
                    />
                  </View>
                  ...
                  <TouchableOpacity
                    onPress={() => {
                      if (
                        ...
                        CarpoolTicket.CarpoolTicket[0].open_chat_password !=
                          "" &&
                        CarpoolTicket.CarpoolTicket[0].open_chat != ""
                      ) {
                        Create();
                        FindOverlay();
                        CarpoolTicket.CarpoolTicket[0].student_number =
