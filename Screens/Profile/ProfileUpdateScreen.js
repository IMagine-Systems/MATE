            ...
            <View style={styles.container}>
                <View style={styles.header}>
                    ...
                    <View style={{alignItems: 'center', width: "80%"}}>
                        <Text style={{fontSize: 16, color: '#575757'}}>내 정보 수정</Text>
                    </View>
                </View>
                ...
                <View style={{flex: deviceHeight < 700 ? 1 : 0.6 }}>
                    <View>
                        ...
                        <View style={{marginTop: 2, marginLeft: 12}}>
                            <Text style={{fontSize: 10, color: "#989595", fontFamily: 'NotoSansKR_400Regular'}}>*드라이버는 자차보유자를, 패신저는 승객(이용자)를 뜻해요!</Text>
                        </View>
