...
export default function DiclationScreen({ navigation, route }) {
  ...
  const token =
    "eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiIzIiwiaXNzIjoiY2FycG9vbCBhcHAiLCJpYXQiOjE2NjQxMDk0MDAsImV4cCI6MTY2NDE5NTgwMH0.Go0keCeAKi3fTzsB3RNhHMVBAZupn_MCkuT0FC-vbnXYRjSB0ik88xbUGzWovx-Bgx4x8if9LfwRbMFIb-V0GA";
    ...
    <KeyboardAvoidingView style={{ flex: 1, backgroundColor: "#F5F5F5" }}>
      <View style={styles.container}>
        ...
        <View style={styles.reason_section}>
          <Text
            style={
              reason === 0 ? styles.reason_selected_text : styles.reason_text
            }
            onPress={() => {
              selectReason(0);
          ...
          <Text
            style={
              reason === 1 ? styles.reason_selected_text : styles.reason_text
            }
            onPress={() => {
              selectReason(1);
          ...
          <Text
            style={
              reason === 2 ? styles.reason_selected_text : styles.reason_text
            }
            onPress={() => {
              selectReason(2);
          ...
          <Text
            style={
              reason === 3 ? styles.reason_selected_text : styles.reason_text
            }
            onPress={() => {
              selectReason(3);
              setEtcContent("");
