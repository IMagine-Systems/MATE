              ...
              if (Platform.OS === "ios") {
                return (
                  <>
                    ...
                    <View
                      style={
                        next[1] === stepbarList[1]
                          ? styles.stepbar_container_first_step
                          : styles.stepbar_container_second_step
                      }
                    ></View>
                    <View
                      style={
                        next[2] === stepbarList[2]
                          ? styles.stepbar_container_first_step
                          : styles.stepbar_container_second_step
                      }
                    ></View>
                ...
                return (
                  <>
                    <View
                      style={styles.andoroid_stepbar_container_first_step}
                    ></View>
                    <View
                      style={
                        next[1] === stepbarList[1]
                          ? styles.andoroid_stepbar_container_first_step
                          : styles.android_stepbar_container_second_step
                      }
                    ></View>
                    <View
                      style={
              ...
              if (next.length === 1) {
                return (
                  <Text
                    style={[
                      styles.title,
                      { fontSize: deviceHeight >= 700 ? 21 : 18 },
                    ]}
                  >
                    어디로 가실 건가요?
                  </Text>
                    ...
                    >
                      ...
                      <View style={styles.selectListContainer}>
                        <SelectList
                          ...
                          onSelect={() => {
                            if (
                              localData.indexOf(startPoint) -
                                (localData.length - 1) <
                              0
                            ) {
                              setEndPoint(
                                localData[localData.indexOf(startPoint) + 1]
                              );
                            } else {
                  ...
                  >
                    <View>
                      <Image
                        ...
                        style={{
                          width: deviceHeight >= 700 ? 32 : 28,
                          height: deviceHeight >= 700 ? 32 : 28,
                        }}
                      />
                    </View>
